...
from .types import Model, PronunciationDictionaryVersionLocator, Voice, VoiceSettings
...
class ElevenLabs(BaseElevenLabs):
    ...
    def __init__(
        ...
        *,
        ...
        self.text_to_speech = RealtimeTextToSpeechClient(
    ...
    def clone(
        ...
        **NOTE**: This function is a helper function and is simply making
        ...
        return self.voices.get(
            add_voice_response.voice_id, request_options=request_options
        )
    ...
    def generate(
        ...
        *,
        ...
        if isinstance(voice, str) and is_voice_id(voice):
            ...
            maybe_voice_id = next(
                (v.voice_id for v in voices_response.voices if v.name == voice), None
            )
            ...
            if voice_settings == DEFAULT_VOICE.settings and voice.settings is not None:
